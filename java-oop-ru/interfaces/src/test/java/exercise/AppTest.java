...
class AppTest {
    ...
    void testReversedSequence1() {
        ...
        CharSequence newText = text.toString();
        assertThat(newText).isEqualTo("fedcba");
        assertThat(newText.charAt(1)).isEqualTo('e');
        assertThat(newText.length()).isEqualTo(6);
        assertThat(newText.subSequence(1, 4)).isEqualTo("edc");
    }
    // END
}
