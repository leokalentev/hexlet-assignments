...
public class PostsController {
    ...
    public static void update(Context ctx) {
        ...
        var inputName = ctx.formParam("name");
        var inputBody = ctx.formParam("body");

        var postWithUserInput = new Post(post.getId(), inputName, inputBody);
        ...
        try {
            ...
            var page = new EditPostPage(postWithUserInput, e.getErrors());
